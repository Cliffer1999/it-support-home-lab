...
# Creates the OU/group skeleton for the xitonglab.local learning domain.
# Run only after the server has been promoted to a domain controller.
...
Write-Host 'AD lab structure setup finished.'